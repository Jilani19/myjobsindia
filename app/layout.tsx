...
export const metadata: Metadata = {
  ...
  description: "Discover the best jobs. Apply to premium roles at top companies via MyJobsIndia.",
  openGraph: {
    title: "MyJobsIndia - Premium Job Platform",
    description: "Discover the best jobs at top companies.",
    url: "https://myjobsindia.com",
      ...
      <body className={inter.className} suppressHydrationWarning>
        ...
        <footer className="bg-slate-900 text-slate-300 py-12 mt-20 border-t border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
            ...
            <p>&copy; {new Date().getFullYear()} MyJobsIndia. All rights reserved.</p>
          </div>
        </footer>
      </body>
    </html>
